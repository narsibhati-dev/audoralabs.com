...
export function BlogPostCard({
  ...
  return (
    <Link
      className="group flex flex-col gap-1 rounded-lg border border-border/50 bg-gradient-to-b from-card-gradient-from to-card-gradient-to p-3 transition-all hover:border-border sm:p-4"
      href={`/blogs/${slug}`}
    >
